        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: const Text("Copy to", style: TextStyle(fontFamily: 'Rubik', color: Color(0xFF404446), fontSize: 16, fontWeight: FontWeight.w400 ),),
            ),
            Container(
              margin: const EdgeInsets.only(top: 16),
              child: Row(
            ...
            Container(
              margin: const EdgeInsets.only(top: 16),
              child: const Text("Approved by", style: TextStyle(fontFamily: 'Rubik', color: Color(0xFF404446), fontSize: 16, fontWeight: FontWeight.w400),),
            ),
            Container(
